...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const voteButton = document.querySelector('.btn-primary[href*="/vote"], .btn-primary[href*="vote"]');
    ...
    loadingOverlay.innerHTML = `
        <div class="loading-spinner" style="
            ...
            margin-bottom: 20px;
        "></div>
        <h3 style="color: white; margin-bottom: 10px;">Chargement du tableau de bord...</h3>

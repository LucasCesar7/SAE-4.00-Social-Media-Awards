...
<head>
    ...
    <title>Conditions Générales d'Utilisation - Social Media Awards</title>
    <link rel="stylesheet" href="<?php echo htmlspecialchars(appUrl('assets/css/base.css'), ENT_QUOTES, 'UTF-8'); ?>">
    <link rel="stylesheet" href="<?php echo htmlspecialchars(appUrl('assets/css/cgu.css'), ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <main class="cgu-container">
        <div class="container">
            ...
            <div class="cgu-navigation">
                <a href="<?php echo htmlspecialchars(publicRouteUrl('privacy'), ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-outline-primary">
